...
function SearchMovies(){
	...
	// Credenciales de API
	const apiKey = 'http://www.omdbapi.com/?i=tt3896198&apikey=fe7a895b'; // Intenta poner cualquier cosa antes para probar
	...
	useEffect(() => { 
		if(searchValue){
			fetch(`http://www.omdbapi.com/?s=${searchValue}&apikey=fe7a895b`)
			.then(response => {
